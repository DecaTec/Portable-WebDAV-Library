...
namespace DecaTec.WebDav.NetFx.UnitTest
{
    ...
    {
        [TestMethod]
        public void UT_NetFx_Prop_CreatePropWithMultipleEmptyPropertiesWithStrings()
        {
        ...
        [TestMethod]
        public void UT_NetFx_Prop_CreatePropWithMultipleEmptyPropertiesWithConstants()
        {
            var serializer = new XmlSerializer(typeof(Prop));

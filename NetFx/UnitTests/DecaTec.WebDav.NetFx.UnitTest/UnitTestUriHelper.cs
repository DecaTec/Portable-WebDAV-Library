...
namespace DecaTec.WebDav.NetFx.UnitTest
{
    ...
    public class UnitTestUriHelper
    {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashNeededUrl()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashNeededUri()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashNotNeededUrl()
        {
            string url = "http://www.google.de/test/";
            string urlWithTrailingSlash = UriHelper.AddTrailingSlash(url);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashNotNeededUri()
        {
            Uri uri = new Uri("http://www.google.de/test/");
            Uri uriWithTrailingSlash = UriHelper.AddTrailingSlash(uri);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_UrlEmpty()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_UrlNull()
        {
            string url = null;
            string urlWithTrailingSlash = UriHelper.AddTrailingSlash(url);
            string expected = "/";
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashTooManySlashesUrl()
        {
            string url = "http://www.google.de//test//";
            string urlWithTrailingSlash = UriHelper.AddTrailingSlash(url);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashTooManySlashesUri()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashFileUrl()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashFileUri()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashFileUrlUrlNull()
        {
            string url = null;
            string urlWithTrailingSlash = UriHelper.AddTrailingSlash(url, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashFileUriUriNull()
        {
            Uri uri = null;
            Uri uriWithTrailingSlash = UriHelper.AddTrailingSlash(uri, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashRelativeUri()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_TrailingSlashRelativeUrl()
        {
            var url = "/webdav/test";
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_UriWithDot()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_UrlWithDot()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_UriWithDotFileExcpected()
        {
            var uri = new Uri("http://www.google.de/a.test/file.txt");
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_AddTrailingSlash_UrlWithDotFileExcpected()
        {
            string url = "http://www.google.de/a.test/file.txt";
            string urlWithTrailingSlash = UriHelper.AddTrailingSlash(url, true);
            string expected = "http://www.google.de/a.test/file.txt";
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_WithBaseUri()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_WithDoubleBaseUri()
        {
            Uri baseUri = new Uri("http://www.google.de/test/");
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_WithBaseUriAndAbsoluteUri()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_WithBaseUriAndAbsoluteUriRemoveDuplicatePath()
        {
            Uri baseUri = new Uri("http://www.google.de/test/test2");
            Uri relativeUri = new Uri("test2/test.txt", UriKind.Relative);
            Uri combinedUri = UriHelper.CombineUri(baseUri, relativeUri, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_WithBaseUriAndAbsoluteUriNoRemoveDuplicatePath()
        {
            Uri baseUri = new Uri("http://www.google.de/test/test2");
            Uri relativeUri = new Uri("test2/test.txt", UriKind.Relative);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_FromSameBaseUri()
        {
            Uri baseUri = new Uri("http://www.google.de/test");
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_FromSameBaseUriAndPath()
        {
            Uri baseUri = new Uri("http://www.google.de/test");
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_WithoutBaseUri()
        {
            Uri baseUri = null;
            Uri relativeUri = new Uri("http://www.google.de/test/test2/");
            Uri combinedUri = UriHelper.CombineUri(baseUri, relativeUri, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_WithTrailingSlashWithTooManySlashes()
        {
        ...
        public void UT_NetFx_UriHelper_CombineUri_FromDifferentBaseUris()
        {
            Uri baseUri = new Uri("http://www.google.de/test");
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_FromBaseUriAndSlash()
        {
            Uri baseUri = new Uri("http://www.google.de/test");
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_FromBaseUriAndSlashTooManySlashes()
        {
            Uri baseUri = new Uri("http://www.google.de/test//");
            Uri relativeUri = new Uri("//", UriKind.RelativeOrAbsolute);
            Uri combinedUri = UriHelper.CombineUri(baseUri, relativeUri, true);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void UT_NetFx_UriHelper_CombineUri_RelativeUriFirst()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_TwoRelativeUris()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_FirstUriEndWithSecondUri()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_FirstUriEndWithSecondUriWithoutSlashSecondUri()
        {
            Uri baseUri = new Uri("http://www.google.de/test/test2/test.txt");
            Uri relativeUri = new Uri("test2/test.txt", UriKind.RelativeOrAbsolute);
            Uri combinedUri = UriHelper.CombineUri(baseUri, relativeUri, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_WithSpacesAndBrackets()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_WithDuplicatePathEntriesRemoveDuplicate()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_WithDuplicatePathEntries()
        {
            Uri baseUri = new Uri("http://google.de/remote.php/webdav/folder-sync/x/");
            Uri relativeUri;
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_WithDuplicatePathEntriesDuplicateRepetition()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_TwoRelativeUrisOverlapping()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_FirstUriNull()
        {
            Uri uri1 = null;
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUri_SecondUriNull()
        {
            var uri1 = new Uri("/test/test2", UriKind.RelativeOrAbsolute);
            Uri uri2 = null;
            var combine = UriHelper.CombineUri(uri1, uri2, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUrl_FirstUrlStringEmpty()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUrl_SecondUrlStringEmpty()
        {
            var url1 = "/test/test2/";
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUrl_FirstUrlNull()
        {
            string url1 = null;
            var url2 = "/test/test2";
            var combine = UriHelper.CombineUrl(url1, url2, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_CombineUrl_SecondUrlNull()
        {
            var url1 = "/test/test2/";
            string url2 = null;
            var combine = UriHelper.CombineUrl(url1, url2, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUriWithTrailingSlash_WithoutTrailingSlashWithBaseUri()
        {
            Uri baseUri = new Uri("http://www.google.de");
            Uri relativeUri = new Uri("test2", UriKind.RelativeOrAbsolute);
            Uri combinedUri = UriHelper.GetCombinedUriWithTrailingSlash(baseUri, relativeUri, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUriWithTrailingSlash_WithTrailingSlashWithBaseUri()
        {
            Uri baseUri = new Uri("http://www.google.de");
            Uri relativeUri = new Uri("test2/", UriKind.RelativeOrAbsolute);
            Uri combinedUri = UriHelper.GetCombinedUriWithTrailingSlash(baseUri, relativeUri, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUriWithTrailingSlash_TooManySlashes()
        {
            Uri baseUri = new Uri("http://www.google.de//");
            Uri relativeUri = new Uri("//test2//", UriKind.RelativeOrAbsolute);
            Uri combinedUri = UriHelper.GetCombinedUriWithTrailingSlash(baseUri, relativeUri, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUriWithTrailingSlash_BaseUriNull()
        {
            Uri baseUri = null;
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUriWithTrailingSlash_RelativeUriNull()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUriWithTrailingSlash_BothUrisNull()
        {
            Uri baseUri = null;
            Uri relativeUri = null;
            var combinedUri = UriHelper.GetCombinedUriWithTrailingSlash(baseUri, relativeUri, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUrlWithTrailingSlash_WithoutTrailingSlashWithBaseUrl()
        {
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUrlWithTrailingSlash_WithTrailingSlashWithBaseUrl()
        {
            var baseUrl = "http://www.google.de";
            var relativeUrl = "test2/";
            var combinedUrl = UriHelper.GetCombinedUrlWithTrailingSlash(baseUrl, relativeUrl, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUrlWithTrailingSlash_TooManySlashes()
        {
            var baseUrl = "http://www.google.de//";
            var relativeUrl = "//test2//";
            var combinedUrl = UriHelper.GetCombinedUrlWithTrailingSlash(baseUrl, relativeUrl, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUrlWithTrailingSlash_BaseUrlNull()
        {
            string baseUrl = null;
            var relativeUrl = "/test2";
            var combinedUrl = UriHelper.GetCombinedUrlWithTrailingSlash(baseUrl, relativeUrl, true);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUrlWithTrailingSlash_RelativeUrlNull()
        {
            var baseUrl = "http://www.google.de//";
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_GetCombinedUrlWithTrailingSlash_BothUrlsNull()
        {
            string baseUrl = null;
            string relativeUrl = null;
            var combinedUrl = UriHelper.GetCombinedUrlWithTrailingSlash(baseUrl, relativeUrl, true);
        ...
        public void UT_NetFx_UriHelper_RemovePortFromUri_UriNull()
        {
            Uri uri = null;
            var actual = UriHelper.RemovePort(uri);
        }
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_RemovePortFromUrl_UrlEmpty()
        {
            string url = string.Empty;
            var actual = UriHelper.RemovePort(url);
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_RemovePortFromUrl_UrlNull()
        {
            string url = null;
            var actual = UriHelper.RemovePort(url);
            string expected = string.Empty;
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_SetPortToUri()
        {
            Uri uri = new Uri("http://www.google.de:8080/test/test2/test.txt");
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_SetPortToUri_RelativeUri()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(NullReferenceException))]
        public void UT_NetFx_UriHelper_SetPortToUri_UriNull()
        {
            Uri uri = null;
            var actual = UriHelper.SetPort(uri, 9999);
        }
        ...
        [TestMethod]
        public void UT_NetFx_UriHelper_SetPortToUrl()
        {
            string url = @"http://www.google.de:8080/test/test2/test.txt";
        ...
        public void UT_NetFx_UriHelper_SetPortToUrl_UrlEmpty()
        {
            string url = string.Empty;
            var actual = UriHelper.SetPort(url, 9999);
        }
        ...
        public void UT_NetFx_UriHelper_SetPortToUrl_UrlNull()
        {
            string url = null;
            var actual = UriHelper.SetPort(url, 9999);
        }
        ...
        public void UT_NetFx_UriHelper_GetPortFromUri_RelativeUri()
        {
            Uri uri = new Uri("test/test2/test.txt", UriKind.RelativeOrAbsolute);
            var actual = UriHelper.GetPort(uri);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void UT_NetFx_UriHelper_GetPortFromUri_UriNull()
        {
            Uri uri = null;
            var actual = UriHelper.GetPort(uri);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(UriFormatException))]
        public void UT_NetFx_UriHelper_GetPortFromUrl_UrlEmpty()
        {
            string url = string.Empty;
            var actual = UriHelper.GetPort(url);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void UT_NetFx_UriHelper_GetPortFromUrl_UrlNull()
        {
            string url = null;
            var actual = UriHelper.GetPort(url);
        }

...
namespace DecaTec.WebDav.Uwp.UnitTest
{
    ...
    public class UnitTestUriHelper
    {
        ...
        [TestMethod]
        public void UT_UWP_UriHelperSetPortToUri()
        {
            Uri uri = new Uri("http://www.google.de:8080/test/test2/test.txt");
        ...
        [TestMethod]
        public void UT_UWP_UriHelperSetPortToUrl()
        {
            string url = @"http://www.google.de:8080/test/test2/test.txt";
        ...
        [TestMethod]
        public void UT_UWP_UriHelper_CombineUriWithSpacesAndBrackets()
        {
        ...
        [TestMethod]
        public void UT_UWP_UriHelper_CombineUriWithDuplicatePathEntriesRemoveDuplicate()
        {
        ...
        [TestMethod]
        public void UT_UWP_UriHelper_CombineUriWithDuplicatePathEntries()
        {
            Uri baseUri = new Uri("http://google.de/remote.php/webdav/folder-sync/x/");
            Uri relativeUri;
